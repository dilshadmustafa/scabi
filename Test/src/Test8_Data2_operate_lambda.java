 ...
 *
 */
public class Test8_Data2_operate_lambda implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(Test8_Data2_operate_lambda.class);
  		Test8_Data2_operate_lambda.log = log;
