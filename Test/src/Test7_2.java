...
public class Test7_2 {
	   ...
	   public static void main(String[] args) throws Exception {
	    	...
	    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
	  		final Logger log = LoggerFactory.getLogger(Test7_2.class);
		    ...
		    */
	    	...
	    	DMeta meta = new DMeta("localhost", "5000");
	     	...
	     	c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(1).maxRetry(3).output(out2);
	     	c.perform();
	     	c.finish();

	     	HashMap<String, String> out3 = new HashMap<String, String>();
	     	c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(1).maxRetry(3).output(out3);
	     	c.perform();
	     	c.finish();
