 ...
 * All Rights Reserved.
 * Created 21-Jan-2016
 * File Name : UnitTest6_Data_VolTest.java
 */
 ...
 *
 */
public class UnitTest6_Data_VolTest implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(UnitTest6_Data_VolTest.class);
  		UnitTest6_Data_VolTest.log = log;
    	...
    	*/
    	...
    	Dson dson = new Dson("Partitions", "100000");
