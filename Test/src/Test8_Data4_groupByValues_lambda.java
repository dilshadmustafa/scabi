 ...
 *
 */
public class Test8_Data4_groupByValues_lambda implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(Test8_Data4_groupByValues_lambda.class);
  		Test8_Data4_groupByValues_lambda.log = log;
    	...
    	try {
	    	d.groupByValues("mydata", "newdata2", (e, c) -> {
															ArrayList<String> alist = new ArrayList<String>();
															alist.add(e.getString());
															return alist;
														});
