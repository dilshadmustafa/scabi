 ...
 *
 */
public class UnitTest6_Data implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(UnitTest6_Data.class);
  		UnitTest6_Data.log = log;
