 ...
 * All Rights Reserved.
 * Created 06-Mar-2016
 * File Name : Test6_4_VolTest.java
 */
...
public class Test6_4_VolTest {
	   ...
	   public static void main(String[] args) throws Exception {
	    	...
	    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
	  		final Logger log = LoggerFactory.getLogger(Test6_4_VolTest.class);
		    ...
		    */
			...
			/*
	     	...
	     	c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(10).maxRetry(3).output(out1);
	     	//c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(1).maxRetry(3).output(out1);	     	
	     	//c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(10).maxRetry(3).output(out1).maxThreads(2);
	     	//c.executeClass(MyPrimeCheckUnit.class).input(jsonInput).split(11).maxRetry(3).output(out1).maxThreads(12);
	     	c.perform();
	     	c.finish();
	     	...
	     	*/
	     	...
	     	DComputeUnit cu = new DComputeUnit() {
	     		public String compute(DComputeContext jsonInput) throws Exception{
	     	...
	     	long time1 = System.currentTimeMillis();
	     	c.executeObject(cu).input(jsonInput).split(10000).output(out2);
	     	c.perform();
	     	try {
	     		c.finish();
	     		c.close();
		    ...
		    */ 	
	     	...
	     	*/
	     	...
	     	FileOutputStream fout = new FileOutputStream("computeoutputhash.csv");
	     	PrintWriter pwriter = new PrintWriter(fout);
	     	for (String s : st2) {
	     		System.out.println("out2 for s : " + s + " value : " + out2.get(s));
	     		pwriter.println(s + "," + out2.get(s));
	     		pwriter.flush();
	     	}
	    	/*
	        if (out3.isEmpty())
