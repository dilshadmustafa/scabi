 ...
 *
 */
public class Test8_Data_operate_clsobjinterface implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(Test8_Data_operate_clsobjinterface.class);
  		Test8_Data_operate_clsobjinterface.log = log;
