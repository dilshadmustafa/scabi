 ...
 *
 */
public class Test8_Data_matrix_vectors implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//System.setProperty(org.slf4j.impl.SimpleLogger.DEFAULT_LOG_LEVEL_KEY, "DEBUG");
  		final Logger log = LoggerFactory.getLogger(Test8_Data_matrix_vectors.class);
  		Test8_Data_matrix_vectors.log = log;
    	System.out.println("ScabiClient");

       	DMeta meta = new DMeta("localhost", "5000");
       	
    	HashMap<String, String> out1 = new HashMap<String, String>();
    	Data d = new Data(meta, 10);  
    	d.output(out1);
