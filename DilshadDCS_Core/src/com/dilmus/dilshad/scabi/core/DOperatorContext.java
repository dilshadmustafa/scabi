 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DOperatorContext.java
 */
 ...
 *
 */
public class DOperatorContext {

	private static final Logger log = LoggerFactory.getLogger(DOperatorContext.class);
	...
	public DOperatorContext(String jsonString) throws IOException {
	...
	public DOperatorContext(String key, String value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext(String key, int value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext(String key, long value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext(String key, float value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext(String key, double value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext(String key, boolean value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DOperatorContext add(String key, String value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DOperatorContext add(String key, int value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DOperatorContext add(String key, long value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DOperatorContext add(String key, float value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DOperatorContext add(String key, double value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DOperatorContext add(String key, boolean value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	private static DOperatorContext createDsonList(HashMap<String, String> hmap, LinkedList<String> fieldNames) {
	    DOperatorContext job = new DOperatorContext();
	...
	private static DOperatorContext createDsonSet(HashMap<String, String> hmap, Set<String> st) {
	    DOperatorContext job = new DOperatorContext();
	...
	private static DOperatorContext createDson(LinkedList<String> arrayofDJsons) {
	    DOperatorContext job = new DOperatorContext();
	    long n = 1;
	...
	private static DOperatorContext createDsonWithCount(LinkedList<String> arrayofDJsons) {
	    DOperatorContext job = new DOperatorContext();
	...
	public static String error(String errorMessage) {
		...
		return (new DOperatorContext("Error", errorMessage)).toString();
	}
	
	public static String result(String result) {
		//return "{ \"Result\" : \"" + result + "\" }";
		return (new DOperatorContext("Result", result)).toString();
	}
	...
	public DOperatorContext getResult() throws IOException {
		return new DOperatorContext(getString("Result"));
	}
	...
	public static DOperatorContext dummy() throws IOException {
		DOperatorContext dson1 = new DOperatorContext("TotalComputeUnit", "0");
		DOperatorContext dson2 = dson1.add("SplitComputeUnit", "0");
		DOperatorContext dson3 = dson2.add("JsonInput", DOperatorContext.empty());
