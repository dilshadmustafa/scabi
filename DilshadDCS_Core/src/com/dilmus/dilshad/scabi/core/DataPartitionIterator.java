 ...
 * All Rights Reserved.
 * Created 25-Sep-2016
 * File Name : DataPartitionIterator.java
 */
 ...
 *
 */
public class DataPartitionIterator implements Iterator<DataElement> {

	private DataPartition m_dataPartition = null;
	...
	public DataPartitionIterator(DataPartition a) {
		m_dataPartition = a; 
    ...
    public boolean hasNext() {
    	if (m_dataPartition.getLastIndex() != m_lastIndex) {
    		throw new RuntimeException(new DScabiException("Last indexes do not match. Concurrent modification error", "DPI.HNT.1"));
    	}
	...
	public DataElement next() {
    	if (m_dataPartition.getLastIndex() != m_lastIndex) {
    		throw new RuntimeException(new DScabiException("Last indexes do not match. Concurrent modification error", "DPI.NET.1"));
    	}
