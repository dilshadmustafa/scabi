...
public class DComputeContext {
	...
	public static DComputeContext dummyDson() throws IOException {
		DComputeContext dson1 = new DComputeContext("TotalComputeUnit", "1");
		DComputeContext dson2 = dson1.add("SplitComputeUnit", "1");
