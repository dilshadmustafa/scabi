 ...
 * All Rights Reserved.
 * @since 06-Feb-2016
 * File Name : DScabiClientException.java
 */
 ...
 *
 */
public class DScabiClientException extends Exception {
    
	private String m_errorCode;
    private String m_message = null;
    
    public DScabiClientException() {
        super();
    }
 
    public DScabiClientException(String message) {
        super(message);
        m_message = message;
    }

    public DScabiClientException(String message, String errorCode) {
    	super(message + " Error Code : " + errorCode);
    	m_message = message + " Error Code : " + errorCode;
    	m_errorCode = errorCode;
    }
    
    public DScabiClientException(Throwable cause) {
        super(cause);
    }
