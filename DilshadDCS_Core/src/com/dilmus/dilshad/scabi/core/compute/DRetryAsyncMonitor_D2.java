 ...
 * All Rights Reserved.
 * Created 02-Mar-2016
 * File Name : DRetryAsyncMonitor_D2.java
 */
...
public class DRetryAsyncMonitor_D2 implements Runnable {
	private final Logger log = LoggerFactory.getLogger(DRetryAsyncMonitor_D2.class);
	...
	private LinkedList<DComputeAsyncRun_D2> m_retryCRunList = null;
	private LinkedList<DComputeAsyncRun_D2> m_listBlockedCRun = null;
	private LinkedList<DComputeAsyncRun_D2> m_allowedCRunList = null;
	
	private LinkedList<DComputeAsyncRun_D2> m_listBlockedCRun2 = null;
	private LinkedList<DComputeAsyncRun_D2> m_allowedCRunList2 = null;	
	...
	public DRetryAsyncMonitor_D2(DCompute compute, DMeta meta) {
		m_compute = compute;
		m_meta = meta;
		...
		m_retryCRunList = new LinkedList<DComputeAsyncRun_D2>();
		
		m_listBlockedCRun = new LinkedList<DComputeAsyncRun_D2>();
		m_allowedCRunList = new LinkedList<DComputeAsyncRun_D2>();
		
		m_listBlockedCRun2 = new LinkedList<DComputeAsyncRun_D2>();
		m_allowedCRunList2 = new LinkedList<DComputeAsyncRun_D2>();
	...
	public int executeRetry() {
		...
		while (check) {
			...
			for (DComputeAsyncRun_D2 crun : m_listBlockedCRun) {
			...
			for (DComputeAsyncRun_D2 crun : m_allowedCRunList) {
...
//===============================================================================================================				
		...
		while (check2) {
			...
			for (DComputeAsyncRun_D2 crun : m_listBlockedCRun2) {
				DComputeNoBlock cnb = crun.getComputeNB();
				boolean proceed = false;
				synchronized(cnb) {
					if (cnb.isAllowed()) {
			...
			for (DComputeAsyncRun_D2 crun : m_allowedCRunList2) {
	...
	public int doRetry() throws ParseException, IOException, DScabiClientException {
		...
		*/
		...
		for (DComputeAsyncRun_D2 crun : m_crunList /* works m_localCRunList*/) {
		...
		*/
		...
		for (DComputeAsyncRun_D2 crun : m_crunList /* Previous works m_localCRunList*/) {
