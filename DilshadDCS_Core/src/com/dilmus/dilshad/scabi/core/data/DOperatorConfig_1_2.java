 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DOperatorConfig_1_2.java
 */
 ...
 *
 */
public class DOperatorConfig_1_2 {
	...
	private final Logger log = LoggerFactory.getLogger(DOperatorConfig_1_2.class);
	...
	public DOperatorConfig_1_2(IOperator2 unit) throws IOException {
		m_operatorObjOfInterface = unit;
		m_configType = DOperatorConfig_1_2.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
