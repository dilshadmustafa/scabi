 ...
 * All Rights Reserved.
 * Created 01-Apr-2017
 * File Name : DMReduceConfig_1_1.java
 */
...
import com.dilmus.dilshad.scabi.core.IReduce;

/**
 * @author Dilshad Mustafa
 *
 */
public class DMReduceConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DMReduceConfig_1_1.class);
	private IReduce m_reduceObjOfInterface = null;
	private Class<?> m_reduceClassOfInterface = null;
	...
	public DMReduceConfig_1_1(IReduce unit) throws IOException {
		m_reduceObjOfInterface = unit;
		m_configType = DMReduceConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DMReduceConfig_1_1(Class<?> cls) throws IOException {
		m_reduceClassOfInterface = cls;
		m_configType = DMReduceConfig_1_1.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public IReduce getReduceObjectOfInterface() {
		return m_reduceObjOfInterface;
	}

	public Class<?> getReduceClassOfInterface() {
		return m_reduceClassOfInterface;
	}

	/* TODO for future DReduce class
	public DReduce getReduceObject() {
		return m_reduceObj;
	}

	public Class<?> getReduceClass() {
		return m_reduceClass;
	}
	*/
