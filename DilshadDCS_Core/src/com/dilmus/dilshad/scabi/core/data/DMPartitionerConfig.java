 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DMPartitionerConfig.java
 */
...
import com.dilmus.dilshad.scabi.core.D1.DataAsyncRun_D1;

/**
 * @author Dilshad Mustafa
 *
 */
public class DMPartitionerConfig implements IConfig {
	...
	private final Logger log = LoggerFactory.getLogger(DMPartitionerConfig.class);
	private DPartitioner m_partitionerObj = null;
	private Class<?> m_partitionerClass = null;
	...
	private LinkedList<DataAsyncRun_D1> m_sourceCRunList = null;
	...
	*/
	...
	public int setSourceCRunList(LinkedList<DataAsyncRun_D1> crunList, long crunListSize, String sourceCRunListJsonStr) {
		m_sourceCRunList = crunList;
		m_sourceCRunListSize = crunListSize;
		m_isSourceCRunListSet = true;
		m_sourceCRunListJsonStr = sourceCRunListJsonStr;
	...
	public DMPartitionerConfig(DPartitioner unit) throws IOException {
		m_partitionerObj = unit;
		m_configType = DMPartitionerConfig.CFG_TYPE_OBJECT;
		m_maxSplit = 1;
	...
	public DMPartitionerConfig(Class<?> cls) throws IOException {
		m_partitionerClass = cls;
		m_configType = DMPartitionerConfig.CFG_TYPE_CLASS;
		m_maxSplit = 1;
	...
	public DPartitioner getPartitionerObject() {
		return m_partitionerObj;
	}

	public Class<?> getPartitionerClass() {
		return m_partitionerClass;
	}
