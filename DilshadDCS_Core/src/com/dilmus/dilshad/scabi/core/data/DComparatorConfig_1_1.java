 ...
 * All Rights Reserved.
 * Created 10-Aug-2016
 * File Name : DComparatorConfig_1_1.java
 */
 ...
 *
 */
public class DComparatorConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DComparatorConfig_1_1.class);
	...
	public DComparatorConfig_1_1(IComparator<?> unit) throws IOException {
		m_comparatorObjOfInterface = unit;
		m_configType = DComparatorConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DComparatorConfig_1_1(Class<?> cls) {
		m_comparatorClassOfInterface = cls;
		m_configType = DComparatorConfig_1_1.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
