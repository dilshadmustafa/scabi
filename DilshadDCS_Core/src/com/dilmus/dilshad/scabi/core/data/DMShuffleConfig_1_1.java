 ...
 *
 */
public class DMShuffleConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DMShuffleConfig_1_1.class);
	...
	public DMShuffleConfig_1_1(IShuffle unit) throws IOException {
		m_shuffleObjOfInterface = unit;
		m_configType = DMShuffleConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
