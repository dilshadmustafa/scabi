...
public class DMShuffle implements IShuffle {
	...
	public DMShuffle(Method m) {
		m_method = m;
	}

	public Iterable<String> groupValues(DataElement e, DataContext c) throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {

		m_method.invoke(null, e, c);
