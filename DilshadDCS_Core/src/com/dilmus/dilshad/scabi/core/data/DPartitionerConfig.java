 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DPartitionerConfig.java
 */
 ...
 *
 */
public class DPartitionerConfig implements IConfig {
	...
	private final Logger log = LoggerFactory.getLogger(DPartitionerConfig.class);
	...
	*/
	...
	public DPartitionerConfig(DPartitioner unit) throws IOException {
		m_partitionerObj = unit;
		m_configType = DPartitionerConfig.CFG_TYPE_OBJECT;
		m_maxSplit = 1;
	...
	public DPartitionerConfig(Class<?> cls) throws IOException {
		m_partitionerClass = cls;
		m_configType = DPartitionerConfig.CFG_TYPE_CLASS;
		m_maxSplit = 1;
