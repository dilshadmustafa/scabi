 ...
 * All Rights Reserved.
 * Created 10-Aug-2016
 * File Name : DShuffleConfig_1_2.java
 */
 ...
 *
 */
public class DShuffleConfig_1_2 {
	...
	private final Logger log = LoggerFactory.getLogger(DShuffleConfig_1_2.class);
	...
	public DShuffleConfig_1_2(IShuffle2 unit) throws IOException {
		m_shuffleObjOfInterface = unit;
		m_configType = DShuffleConfig_1_2.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DShuffleConfig_1_2(Class<?> cls) {
		m_shuffleClassOfInterface = cls;
		m_configType = DShuffleConfig_1_2.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
