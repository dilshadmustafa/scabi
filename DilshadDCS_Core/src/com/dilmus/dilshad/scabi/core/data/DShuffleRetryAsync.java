 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DShuffleRetryAsync.java
 */
...
public class DShuffleRetryAsync implements Runnable {
	private final Logger log = LoggerFactory.getLogger(DShuffleRetryAsync.class);
	...
	public DShuffleRetryAsync(Data compute, DMeta meta) {
		m_compute = compute;
		m_meta = meta;
