 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DOperatorConfig_1_1.java
 */
 ...
 *
 */
public class DOperatorConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DOperatorConfig_1_1.class);
	...
	public DOperatorConfig_1_1(IOperator unit) throws IOException {
		m_operatorObjOfInterface = unit;
		m_configType = DOperatorConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DOperatorConfig_1_1(Class<?> cls) {
		m_operatorClassOfInterface = cls;
		m_configType = DOperatorConfig_1_1.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
