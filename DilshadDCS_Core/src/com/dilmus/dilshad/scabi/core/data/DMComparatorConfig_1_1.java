 ...
 * All Rights Reserved.
 * Created 10-Aug-2016
 * File Name : DMComparatorConfig_1_1.java
 */
 ...
 *
 */
public class DMComparatorConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DMComparatorConfig_1_1.class);
	private IComparator<?> m_comparatorObjOfInterface = null;
	private Class<?> m_comparatorClassOfInterface = null;
	...
	public DMComparatorConfig_1_1(IComparator<?> unit) throws IOException {
		m_comparatorObjOfInterface = unit;
		m_configType = DMComparatorConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DMComparatorConfig_1_1(Class<?> cls) {
		m_comparatorClassOfInterface = cls;
		m_configType = DMComparatorConfig_1_1.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public IComparator<?> getComparatorObjectOfInterface() {
		return m_comparatorObjOfInterface;
	}

	public Class<?> getComparatorClassOfInterface() {
		return m_comparatorClassOfInterface;
	}

	/* TODO for future DComparator class
	public DComparator getComparatorObject() {
		return m_comparatorObj;
	}

	public Class<?> getComparatorClass() {
		return m_comparatorClass;
	}
	*/
