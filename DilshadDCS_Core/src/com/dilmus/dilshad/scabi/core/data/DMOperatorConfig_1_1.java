 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DMOperatorConfig_1_1.java
 */
 ...
 *
 */
public class DMOperatorConfig_1_1 {
	...
	private final Logger log = LoggerFactory.getLogger(DMOperatorConfig_1_1.class);
	private IOperator m_operatorObjOfInterface = null;
	...
	public DMOperatorConfig_1_1(IOperator unit) throws IOException {
		m_operatorObjOfInterface = unit;
		m_configType = DMOperatorConfig_1_1.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DMOperatorConfig_1_1(Class<?> cls) throws IOException {
		m_operatorClassOfInterface = cls;
		m_configType = DMOperatorConfig_1_1.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public IOperator getOperatorObjectOfInterface() {
	...
	/* TODO for future DOperator class
	public DOperator getOperatorObject() {
		return m_operatorObj;
	}

	public Class<?> getOperatorClass() {
		return m_operatorClass;
	}
	*/
