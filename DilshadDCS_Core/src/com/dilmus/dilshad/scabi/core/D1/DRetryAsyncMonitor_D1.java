 ...
 * All Rights Reserved.
 * Created 02-Mar-2016
 * File Name : DRetryAsyncMonitor_D1.java
 */
...
public class DRetryAsyncMonitor_D1 implements Runnable {
	private final Logger log = LoggerFactory.getLogger(DRetryAsyncMonitor_D1.class);
	...
	private LinkedList<DComputeAsyncRun_D1> m_retryCRunList = null;
	private LinkedList<DComputeAsyncRun_D1> m_allowedCRunList = null;
	
	private long m_cnbListSize = 0; // TODO change to long
	
	public DRetryAsyncMonitor_D1(DCompute compute, DMeta meta) {
		m_compute = compute;
		m_meta = meta;
		...
		m_retryCRunList = new LinkedList<DComputeAsyncRun_D1>();
		m_allowedCRunList = new LinkedList<DComputeAsyncRun_D1>();
	...
	public int executeRetry() {
		...
		while (check) {
			...
			for (DComputeAsyncRun_D1 crun : m_retryCRunList) {
			...
			*/
			...
			for (DComputeAsyncRun_D1 crun : m_allowedCRunList) {
	...
	public int doRetry() throws ParseException, IOException, DScabiClientException {
		...
		*/
		...
		for (DComputeAsyncRun_D1 crun : m_crunList /* works m_localCRunList*/) {
		...
		*/
		...
		for (DComputeAsyncRun_D1 crun : m_crunList /* Previous works m_localCRunList*/) {
