...
public class DataContext {
	...
	public DataContext(String key, String value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext(String key, int value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext(String key, long value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext(String key, float value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext(String key, double value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext(String key, boolean value) {
		long thisThreadId = Thread.currentThread().getId();
		synchronized(m_mapThreadIdOM) {
			if (m_mapThreadIdOM.containsKey("" + thisThreadId))
				m_objectMapper = m_mapThreadIdOM.get("" + thisThreadId);
	...
	public DataContext add(String key, String value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DataContext add(String key, int value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DataContext add(String key, long value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DataContext add(String key, float value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DataContext add(String key, double value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	public DataContext add(String key, boolean value) {
		m_root.put(key, value);
		m_isChanged = true;
		m_isDsonEmpty = false;
		return this;
	...
	private static DataContext createDsonList(HashMap<String, String> hmap, LinkedList<String> fieldNames) {
	    DataContext job = new DataContext();
	...
	private static DataContext createDsonSet(HashMap<String, String> hmap, Set<String> st) {
	    DataContext job = new DataContext();
	...
	private static DataContext createDson(LinkedList<String> arrayofDJsons) {
	    DataContext job = new DataContext();
	    long n = 1;
	...
	private static DataContext createDsonWithCount(LinkedList<String> arrayofDJsons) {
	    DataContext job = new DataContext();
	...
	public static String error(String errorMessage) {
		...
		return (new DataContext("Error", errorMessage)).toString();
	}
	
	public static String result(String result) {
		//return "{ \"Result\" : \"" + result + "\" }";
		return (new DataContext("Result", result)).toString();
	}
	...
	public DataContext getResult() throws IOException {
	...
	public static DataContext dummy() throws IOException {
		DataContext dson1 = new DataContext("TotalComputeUnit", "0");
