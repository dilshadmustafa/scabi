 ...
 * All Rights Reserved.
 * Created 28-Feb-2016
 * File Name : DThreadPoolExecutor_D1.java
 */
 ...
 *
 */
public class DThreadPoolExecutor_D1 extends ThreadPoolExecutor {

	private DComputeSync_D1 m_compute = null;
	// Previous works private HashMap<Future<?>, DComputeSyncRun> m_localFutureCRunMap = null;
	
	public DThreadPoolExecutor_D1(int corePoolSize, int maximumPoolSize, long keepAliveTime,
		      					TimeUnit unit, BlockingQueue<Runnable> workQueue, DComputeSync_D1 compute) {
	...
	protected void afterExecute(Runnable r, Throwable t) {
		  ...
		  if (t == null && r instanceof Future<?>) {
			  ...
			  try {
				  ...
				  DComputeSyncRun_D1 crun = m_compute.getFutureCRunMap(future);
