 ...
 * All Rights Reserved.
 * Created 27-Jan-2016
 * File Name : DComputeBlock_D1.java
 */
 ...
 *
 */
public class DComputeBlock_D1 {

	private final Logger log = LoggerFactory.getLogger(DComputeBlock_D1.class);
	...
	private LinkedList<DComputeBlock_D1> m_anotherList = null;
	
	private String m_jobId = null;
	private String m_configId = null;
	private String m_taskId = null;
	
	private DComputeBlock_D1 m_clonedFrom = null;
	...
	private long m_maxClientConnectionsPerRoute = 1;
	
	private DComputeSyncConfig_D1 m_config = null;
	
	public int setConfig(DComputeSyncConfig_D1 config) {
		m_config = config;
	...
	private int setClonedFrom(DComputeBlock_D1 clonedFrom) {
	...
	public DComputeBlock_D1 another() throws Exception {
		if (m_CBOBJECTCOUNT >= m_MAXCBTHREADS)
			return null;
		
		DComputeBlock_D1 cb = null;
		cb = new DComputeBlock_D1(m_jsonString);
	...
	public DComputeBlock_D1(String jsonString) throws IOException {
		...
		m_anotherList = new LinkedList<DComputeBlock_D1>();
	...
	public DComputeBlock_D1(DMeta meta) throws IOException {
	...
	public int setFaulty(boolean isFaulty) {
		...
		*/
		...
		if (null == m_clonedFrom) {
				...
				for (DComputeBlock_D1 cb : m_anotherList)
					cb.setFaulty(isFaulty);
	...
	public String executeCode(String bshSource) throws ClientProtocolException, IOException, DScabiException {
		...
		*/
		...
		if (m_config.isCombinedJarsSet()) {
			...
			throw new DScabiException("Combined Jars is not set", "CBK.ECE.1");
	...
	public String executeClass(Class<? extends DComputeUnit> cls) throws ClientProtocolException, IOException, DScabiException {
		...
		*/
		...
		if (m_config.isCombinedJarsSet()) {
			...
			throw new DScabiException("Combined Jars is not set", "CBK.ECS.1");
	...
	public String executeObject(DComputeUnit obj) throws ClientProtocolException, IOException, DScabiException {
		...
		*/
		...
		if (m_config.isCombinedJarsSet()) {
			...
			throw new DScabiException("Combined Jars is not set", "CBK.EOT.1");
	...
	public String executeClassNameInJar(String jarFilePath, String classNameInJar) throws ClientProtocolException, IOException, DScabiException {
		...
		*/
		...
		if (m_config.isCombinedJarsSet()) {
			...
			throw new DScabiException("Combined Jars is not set", "CBK.ECR.1");
