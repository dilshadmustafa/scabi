...
public class DMDao {
	...
	private DMNamespace m_namespace = null;
	
	public DMDao(DDB ddb) {
		m_ddb = ddb;
		m_tableName = null;
		m_firstTime = true;
		m_fieldNames = null;
	...
	public DMDao(String dbHost, String dbPort, String dbName) {
	...
	public DMDao(DMNamespace namespace) throws DScabiException {
	...
	*/
	...
	public int setNamespace(DMNamespace namespace) throws DScabiException {
		if (false == namespace.getType().equals("AppTable")) {
			close();
	...
	public int setNamespace(String strNamespace) throws DScabiException, IOException {
		DMNamespace namespace = new DMNamespace(strNamespace);
		if (false == namespace.getType().equals("AppTable")) {
			close();
