 ...
 * All Rights Reserved.
 * @since 26-Jan-2016
 * File Name : DScabiException.java
 */
 ...
 *
 */
public class DScabiException extends Exception {
    
	private String m_errorCode;

    private String m_message = null;
    
    public DScabiException() {
        super();
    }
 
    public DScabiException(String message) {
        super(message);
        m_message = message;
    }

    public DScabiException(String message, String errorCode) {
    	super(message + " Error Code : " + errorCode);
    	m_message = message + " Error Code : " + errorCode;
    	m_errorCode = errorCode;
    }
    
    public DScabiException(Throwable cause) {
        super(cause);
    }
