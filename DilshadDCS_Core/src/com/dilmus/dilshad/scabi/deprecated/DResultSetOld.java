 ...
 *
 */
public class DResultSetOld {

	DBCursor m_cursor = null;
	DObject m_dob = null;
	
	public DResultSetOld(DBCursor cursor) {
		m_cursor = cursor;
		m_dob = new DObject();
	}

	public DResultSetOld() {
		m_cursor = null;
		m_dob = new DObject();
	}
	
	public int set(DBCursor cursor) {
		m_cursor = cursor;
		return 0;
	}
	...
	public DObject next() {
		m_dob.set(m_cursor.next());
		return m_dob;
	}
	
	public DObject nextDirect() {
		return new DObject(m_cursor.next());
	}
