 ...
 * All Rights Reserved.
 * Created 18-Jul-2016
 * File Name : DOperatorConfig_2_2.java
 */
 ...
 *
 */
public class DOperatorConfig_2_2 {
	...
	private final Logger log = LoggerFactory.getLogger(DOperatorConfig_2_2.class);
	...
	public DOperatorConfig_2_2(IOperator2 unit) throws IOException {
		m_operatorObjOfInterface = unit;
		m_configType = DOperatorConfig_2_2.CFG_TYPE_OBJECT_OF_INTERFACE;
		m_maxSplit = 1;
	...
	public DOperatorConfig_2_2(Class<?> cls) {
		m_operatorClassOfInterface = cls;
		m_configType = DOperatorConfig_2_2.CFG_TYPE_CLASS_OF_INTERFACE;
		m_maxSplit = 1;
