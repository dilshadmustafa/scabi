...
5. In terminal window, cd to /home/(username)/myworkspace folder
6. Run commands,
...
8. Run command,
		...
		File scabi-0.2.3.jar will be created inside /home/(username)/myworkspace/scabi/target
		
		All the dependency jars will be copied to /home/(username)/myworkspace/scabi/target/dependency-jars
...
13. Storage directory (-Dscabi.dfs.mount.dir="/home/(username)/testdata/storage") or Storage system (S3-interface Storage system, SeaweedFS, etc. e.g. -Dscabi.seaweedfs.config="localhost-8888") should be set the same value for all Compute Service nodes (DilshadDCS_CS->ComputerServer_D2.java) and Driver code (e.g. Test->Test8_Data2_operate_lambda.java) as the storage system forms the Data Ring.
...
Replace **(username)** with your user name in all the steps.
6. In terminal window, cd to /home/(username)/myworkspace folder
7. Run commands,
...
8. Inside /home/(username)/myworkspace/scabi/Download folder, extract the file scabi.tar.gz and copy all the jar files from the folder named "dependency-jars". 
	...
	Or alternatively, use /home/(username)/myworkspace/scabi/pom.xml file to get all the dependency jar files.
9. In Eclipse, import the following folders /home/(username)/myworkspace/scabi/DilshadDCS_Core, /home/(username)/myworkspace/scabi/DilshadDCS_CS, /home/(username)/myworkspace/scabi/DilshadDCS_MS, /home/(username)/myworkspace/StorageHandler/Dilshad_StorageHandler and /home/(username)/myworkspace/scabi/Test as **separate** projects using File->Import->Existing Projects into Workspace.
